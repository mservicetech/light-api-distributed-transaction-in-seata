...
@Ignore
public class ResetPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ResetPutHandlerTest.class);
    ...
    @Test
    public void testResetPutHandlerTest() throws ClientException {
