...
@Ignore
public class InventoriesGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(InventoriesGetHandlerTest.class);
    ...
    @Test
    public void testInventoriesGetHandlerTest() throws ClientException {
