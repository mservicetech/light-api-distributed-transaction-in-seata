...
@Ignore
public class UpdateInventoryPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UpdateInventoryPutHandlerTest.class);
    ...
    @Test
    public void testUpdateInventoryPutHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/updateInventory";
