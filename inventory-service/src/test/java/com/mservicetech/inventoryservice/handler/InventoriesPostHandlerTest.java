...
@Ignore
public class InventoriesPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(InventoriesPostHandlerTest.class);
    ...
    @Test
    public void testInventoriesPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/inventories";
