...
public class AccountsAccountIdResetPutHandlerTest {
    ...
    static final Logger logger = LoggerFactory.getLogger(AccountsAccountIdResetPutHandlerTest.class);
    ...
    @Test
    public void testAccountsAccountIdResetPutHandlerTest() throws ClientException {
